...
describe MajorsController do
  ...
  let(:valid_attributes) { { "classname" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved major as @major" do
        ...
        post :create, {:major => { "classname" => "invalid value" }}, valid_session
        assigns(:major).should be_a_new(Major)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested major" do
        ...
        Major.any_instance.should_receive(:update_attributes).with({ "classname" => "MyString" })
        put :update, {:id => major.to_param, :major => { "classname" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the major as @major" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Major.any_instance.stub(:save).and_return(false)
        put :update, {:id => major.to_param, :major => { "classname" => "invalid value" }}, valid_session
        assigns(:major).should eq(major)
      end
